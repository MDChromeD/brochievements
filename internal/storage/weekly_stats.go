...
// func (s *Storage) LoadWeeklyStats(from, to time.Time) ([]WeeklyStat, error) {
...
// func (s *Storage) LoadWeeklyAFK(stats []WeeklyUserStats) error {
...
// func (s *Storage) LoadWeeklyMaxGame(stats []WeeklyUserStats) error {
// 	from, _ := lastWeekRange()
